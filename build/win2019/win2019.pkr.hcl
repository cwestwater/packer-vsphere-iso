...
source "vsphere-iso" "win2019dccore" {
    ...
    floppy_files = [
        "../../bootfiles/win2019/datacentercore/autounattend.xml",
...
source "vsphere-iso" "win2019dc" {
    ...
    floppy_files = [
        "../../bootfiles/win2019/datacenter/autounattend.xml",
        "../../scripts/common/install-vmtools64.cmd",
        "../../scripts/common/initial-setup.ps1"
    ]
...
source "vsphere-iso" "win2019stdcore" {
    ...
    floppy_files = [
        "../../bootfiles/win2019/standardcore/autounattend.xml",
        "../../scripts/common/install-vmtools64.cmd",
        "../../scripts/common/initial-setup.ps1"
    ]
